...
knowledge3 = And(
     ...
     Implication(BKnave,Not(And(Implication(AKnave,AKnight),Implication(AKnight,AKnave)))),
     Implication(BKnight,And(Implication(AKnave,AKnight),Implication(AKnight,AKnave))),
